...
调用位置:cn-patent-project-drafting 编排器在 step 3 用户分流决策选"交付专利部"时。
...
由编排器在专利部接手后通过 AskUserQuestion 逐题问。候选项动态从上游产物抽取(见 cn-patent-project-drafting/assets/decision-categories.json)。
